  ...
  jQuery.extend(!0, b, {
      ...
      prepareSingleCaption: function(a) {
          ...
          c.find("img").length > 0) {
              ...
              o = s(n.data("ww"), e)[e.curWinRange] || s(n.data("ww"), e) || "auto",
              p = s(n.data("hh"), e)[e.curWinRange] || s(n.data("hh"), e) || "auto";
              ...
              if ("full-proportional" === o) {
                  ...
                  o = u ? q : !jQuery.isNumeric(o) && o.indexOf("%") > 0 ? o : parseFloat(o),
                  p = x ? r : !jQuery.isNumeric(p) && p.indexOf("%") > 0 ? p : parseFloat(p);
              o = void 0 === o ? 0 : o,
              p = void 0 === p ? 0 : p,
              "off" !== d._responsive ? ("grid" != d._ba && u ? jQuery.isNumeric(o) ? n.css({
                  width: o + "px"
              }) : n.css({
                  width: o
          ...
          if (c.hasClass("tp-videolayer") || c.hasClass("tp-audiolayer") || c.find("iframe").length > 0 || c.find(B).length > 0) {
              ...
              !jQuery.isNumeric(o) && o.indexOf("%") > 0 ? p = parseFloat(p) * e.bh + "px" : (o = parseFloat(o) * e.bw + "px",
              p = parseFloat(p) * e.bh + "px"),
              d.cssobj = void 0 === d.cssobj ? v(c, 0) : d.cssobj;
              var G = w(d.cssobj, e);
          ...
          y(c, e, 0, d._responsive),
          c.hasClass("tp-resizeme") && c.find("*").each(function() {
              y(jQuery(this), e, "rekursive", d._responsive)
          });
          var I = c.outerHeight()
            , J = c.css("backgroundColor");
          t(c, ".frontcorner", "left", "borderRight", "borderTopColor", I, J),
          t(c, ".frontcornertop", "left", "borderRight", "borderBottomColor", I, J),
          t(c, ".backcorner", "right", "borderLeft", "borderBottomColor", I, J),
          t(c, ".backcornertop", "right", "borderLeft", "borderTopColor", I, J),
          ...
          d.arrobj = new Object,
          d.arrobj.voa = s(d.voffset, e)[e.curWinRange] || s(d.voffset, e)[0],
          d.arrobj.hoa = s(d.hoffset, e)[e.curWinRange] || s(d.hoffset, e)[0],
          d.arrobj.elx = s(d.x, e)[e.curWinRange] || s(d.x, e)[0],
          d.arrobj.ely = s(d.y, e)[e.curWinRange] || s(d.y, e)[0];
      ...
      buildFullTimeLine: function(a) {
          var h, i, c = a.caption, d = c.data(), e = a.opt, g = {}, j = n();
          if (h = e.timelines[d._slideid].layers[d._id],
          !h.generated || a.regenerate === !0) {
              if (i = h.timeline,
              h.generated = !0,
              ...
              i.clear(),
              g.svg = void 0 != d.svg_src && c.find("svg"),
              g.svg && (d.idlesvg = l(d.svg_idle, k()),
              punchgs.TweenLite.set(g.svg, d.idlesvg.anim)),
              d.hoverframeindex !== -1 && void 0 !== d.hoverframeindex && !c.hasClass("rs-hover-ready")) {
                  if (c.addClass("rs-hover-ready"),
                  d.hovertimelines = {},
                  d.hoveranim = q(j, d.frames[d.hoverframeindex].to),
                  d.hoveranim = u(d.hoveranim, d.frames[d.hoverframeindex].style),
                  g.svg) {
                      var o = l(d.svg_hover, k());
                      void 0 != d.hoveranim.anim.color && (o.anim.fill = d.hoveranim.anim.color,
                      d.idlesvg.anim.css.fill = g.svg.css("fill")),
                      d.hoversvg = o
                  }
                  c.hover(function(a) {
                      var b = {
                      ...
                      b.caption)
                        ...
                        , j = !0;
                      h.forcehover = i.force,
                      j && (h.hovertimelines.item = punchgs.TweenLite.to(d, i.speed / 1e3, h.hoveranim.anim),
                      (h.hoverzIndex || h.hoveranim.anim && h.hoveranim.anim.zIndex) && (h.basiczindex = void 0 === h.basiczindex ? h.cssobj.zIndex : h.basiczindex,
                      h.hoverzIndex = void 0 === h.hoverzIndex ? h.hoveranim.anim.zIndex : h.hoverzIndex,
                      h.inhoverinanimation = !0,
                      0 === i.speed && (h.inhoverinanimation = !1),
                      h.hovertimelines.pwhoveranim = punchgs.TweenLite.to(h._pw, i.speed / 1e3, {
                          overwrite: "auto",
                      ...
                      g.svg && (h.hovertimelines.svghoveranim = punchgs.TweenLite.to([g.svg, g.svg.find("path")], i.speed / 1e3, h.hoversvg.anim)),
                      h.hoveredstatus = !0)
                  }, function(a) {
                      var b = {
                          caption: jQuery(a.currentTarget),
                      ...
                      b.caption)
                        ...
                        , j = !0;
                      j && (h.hoveredstatus = !1,
                      h.inhoveroutanimation = !0,
                      h.hovertimelines.item.pause(),
                      h.hovertimelines.item = punchgs.TweenLite.to(d, i.speed / 1e3, jQuery.extend(!0, {}, h._gsTransformTo)),
                      0 == i.speed && (h.inhoveroutanimation = !1),
                      h.hovertimelines.item.eventCallback("onComplete", function(a) {
                          a.inhoveroutanimation = !1
                      }, [h]),
                      void 0 !== h.hovertimelines.pwhoveranim && (h.hovertimelines.pwhoveranim = punchgs.TweenLite.to(h._pw, i.speed / 1e3, {
                          overwrite: "auto",
              ...
              for (var p = 0; p < d.frames.length; p++)
                  if (p !== d.hoverframeindex) {
                      ...
                      d.frames[p].framename = r,
                      h[r] = {},
                      h[r].timeline = new punchgs.TimelineLite({
                          align: "normal"
                      });
                      var s = d.frames[p].delay
                        , v = (d.triggered_startstatus,
                      void 0 !== s ? jQuery.inArray(s, ["slideenter", "bytrigger", "wait"]) >= 0 ? s : parseInt(s, 0) / 1e3 : "wait");
                      void 0 !== h.firstslide && "frame_0" === r && (i.addLabel("slide_" + h.firstslide + "_pause", 0),
                      i.addPause("slide_" + h.firstslide + "_pause"),
                      i.addLabel("slide_" + h.firstslide, "+=0.005")),
                      void 0 !== h.lastslide && "frame_999" === r && (i.addLabel("slide_" + h.lastslide + "_pause", "+=0.01"),
                      i.addPause("slide_" + h.lastslide + "_pause"),
                      i.addLabel("slide_" + h.lastslide, "+=0.005")),
                      jQuery.isNumeric(v) ? i.addLabel(r, "+=" + v) : (i.addLabel("pause_" + p, "+=0.01"),
                      i.addPause("pause_" + p),
                      i.addLabel(r, "+=0.01")),
                      i = b.createFrameOnTimeline({
                          caption: a.caption,
                          timeline: i,
                          label: r,
                          frameindex: p,
              ...
              a.regenerate || (d.current_is_nc_timeline && (d.current_timeline = i),
              d.current_timeline_pause ? i.pause(d.current_timeline_time) : i.time(d.current_timeline_time))
          }
      },
      createFrameOnTimeline: function(a) {
          var c = a.caption
            ...
            , w = !1;
          if (u = void 0 === u ? "forward" : u,
          d.hoverframeindex !== -1 && d.hoverframeindex == s && (s -= 1),
          n.content = new punchgs.TimelineLite({
              align: "normal"
          }),
          n.mask = new punchgs.TimelineLite({
              align: "normal"
          }),
          void 0 === f.vars.id && (f.vars.id = Math.round(1e5 * Math.random())),
          "column" === d._nctype && (f.add(punchgs.TweenLite.set(d._cbgc_man, {
              display: "block"
          }), e),
          f.add(punchgs.TweenLite.set(d._cbgc_auto, {
              display: "none"
          }), e)),
          d.splittext && 0 === g) {
          ...
          void 0 !== d.mySplitText && t && t.match(/chars|words|lines/g) && (l = d.mySplitText[t],
          w = !0);
          var D, E, y = g !== d.outframeindex ? q(j(), d.frames[g].to, void 0, w, l.length - 1) : void 0 !== d.frames[g].to && null === d.frames[g].to.match(/auto:auto/g) ? q(m(), d.frames[g].to, 1 == k.sdir, w, l.length - 1) : q(m(), d.frames[d.inframeindex].from, 0 == k.sdir, w, l.length - 1), B = void 0 !== d.frames[g].from ? q(y, d.frames[d.inframeindex].from, 1 == k.sdir, w, l.length - 1) : void 0, C = d.frames[g].splitdelay;
          if (0 !== g || a.fromcurrentstate ? E = r(d.frames[g].mask) : D = r(d.frames[g].mask),
          y.anim.ease = void 0 === d.frames[g].ease ? punchgs.Power1.easeInOut : d.frames[g].ease,
          void 0 !== B && (B.anim.ease = void 0 === d.frames[g].ease ? punchgs.Power1.easeInOut : d.frames[g].ease,
          B.speed = void 0 === d.frames[g].speed ? B.speed : d.frames[g].speed,
          B.anim.x = B.anim.x * k.bw || p(B.anim.x, k, d.eow, d.eoh, d.calcy, d.calcx, "horizontal"),
          B.anim.y = B.anim.y * k.bw || p(B.anim.y, k, d.eow, d.eoh, d.calcy, d.calcx, "vertical")),
          void 0 !== y && (y.anim.ease = void 0 === d.frames[g].ease ? punchgs.Power1.easeInOut : d.frames[g].ease,
          y.speed = void 0 === d.frames[g].speed ? y.speed : d.frames[g].speed,
          y.anim.x = y.anim.x * k.bw || p(y.anim.x, k, d.eow, d.eoh, d.calcy, d.calcx, "horizontal"),
          y.anim.y = y.anim.y * k.bw || p(y.anim.y, k, d.eow, d.eoh, d.calcy, d.calcx, "vertical")),
          c.data("iframes") && f.add(punchgs.TweenLite.set(c.find("iframe"), {
              autoAlpha: 1
          }), e + "+=0.001"),
          g === d.outframeindex && (d.frames[g].to && d.frames[g].to.match(/auto:auto/g),
          y.speed = void 0 === d.frames[g].speed || "inherit" === d.frames[g].speed ? d.frames[d.inframeindex].speed : d.frames[g].speed,
          y.anim.ease = void 0 === d.frames[g].ease || "inherit" === d.frames[g].ease ? d.frames[d.inframeindex].ease : d.frames[g].ease,
          y.anim.overwrite = "auto"),
          0 !== g || a.fromcurrentstate)
              0 === g && a.fromcurrentstate && (y.speed = B.speed);
          else {
              if (l != c) {
                  var F = jQuery.extend({}, y.anim, !0);
                  f.add(punchgs.TweenLite.set(c, y.anim), e),
                  y = j(),
                  y.ease = F.ease,
                  void 0 !== F.filter && (y.anim.filter = F.filter),
                  void 0 !== F["-webkit-filter"] && (y.anim["-webkit-filter"] = F["-webkit-filter"])
              }
              B.anim.visibility = "hidden",
              B.anim.immediateRender = !0,
              y.anim.visibility = "visible"
          }
          ...
          if (0 === g && !a.fromcurrentstate && void 0 !== d._bmask && void 0 !== v && v.indexOf("block") >= 0 || g === d.outframeindex && !a.fromcurrentstate && void 0 !== d._bmask && void 0 !== v && v.indexOf("block") >= 0) {
              ...
              I[0].background = d.frames[g].sfxcolor,
              f.add(n.mask.fromTo(d._bmask, H, I[0], I[1], C), e),
              f.add(n.mask.to(d._bmask, H, J, G), e)
          }
          if (w)
              var K = h(l.length - 1, u);
          if (0 !== g || a.fromcurrentstate)
              if ("block" === d._sfx_out && g === d.outframeindex)
                  f.add(n.content.staggerTo(l, .001, {
                      autoAlpha: 0,
                      delay: G
                  }), e),
                  f.add(n.content.staggerTo(l, y.speed / 1e3 / 2 - .001, {
                      x: 0,
                      delay: G
                  }), e + "+=0.001");
              else if (w && void 0 !== K) {
                  ...
                  f.add(n.content.staggerTo(l, y.speed / 1e3, y.anim, C), e);
          else if ("block" === d._sfx_in)
              f.add(n.content.staggerFromTo(l, .05, {
                  x: 0,
                  y: 0,
                  autoAlpha: 0
              }, {
              ...
              for (var M in l) {
                  ...
                  O.ease = N.ease,
                  f.add(n.content.fromTo(l[K[M]], B.speed / 1e3, N, O, C * M), e)
              }
          } else
              f.add(n.content.staggerFromTo(l, B.speed / 1e3, B.anim, y.anim, C), e);
          return void 0 === E || E === !1 || 0 === g && a.ignorefirstframe || (E.anim.ease = void 0 === E.anim.ease || "inherit" === E.anim.ease ? d.frames[0].ease : E.anim.ease,
          E.anim.overflow = "hidden",
          E.anim.x = E.anim.x * k.bw || p(E.anim.x, k, d.eow, d.eoh, d.calcy, d.calcx, "horizontal"),
          E.anim.y = E.anim.y * k.bw || p(E.anim.y, k, d.eow, d.eoh, d.calcy, d.calcx, "vertical")),
          0 === g && D && D !== !1 && !a.fromcurrentstate || 0 === g && a.ignorefirstframe ? (E = new Object,
          E.anim = new Object,
          E.anim.overwrite = "auto",
          E.anim.ease = y.anim.ease,
          E.anim.x = E.anim.y = 0,
          D && D !== !1 && (D.anim.x = D.anim.x * k.bw || p(D.anim.x, k, d.eow, d.eoh, d.calcy, d.calcx, "horizontal"),
          D.anim.y = D.anim.y * k.bw || p(D.anim.y, k, d.eow, d.eoh, d.calcy, d.calcx, "vertical"),
          D.anim.overflow = "hidden")) : 0 === g && f.add(n.mask.set(d._mw, {
              overflow: "visible"
          }), e),
          void 0 !== D && void 0 !== E && D !== !1 && E !== !1 ? f.add(n.mask.fromTo(d._mw, B.speed / 1e3, D.anim, E.anim, C), e) : void 0 !== E && E !== !1 && f.add(n.mask.to(d._mw, y.speed / 1e3, E.anim, C), e),
          f.addLabel(e + "_end"),
          d._gsTransformTo && g === s && d.hoveredstatus && (d.hovertimelines.item = punchgs.TweenLite.to(c, 0, d._gsTransformTo)),
          d._gsTransformTo = !1,
          n.content.eventCallback("onStart", function(a, c, d, e, f, g, h, i) {
              var j = {};
              if (j.layer = h,
              j.eventtype = 0 === a ? "enterstage" : a === e.outframeindex ? "leavestage" : "framestarted",
              j.layertype = h.data("layertype"),
              e.active = !0,
              j.frame_index = a,
              j.layersettings = h.data(),
              k.c.trigger("revolution.layeraction", [j]),
              "on" == e.loopanimation && A(e._lw, k.bw),
              "enterstage" === j.eventtype && (e.animdirection = "in",
              e.visibleelement = !0,
          ...
          }, [g, o, d._pw, d, f, y.anim, c, a.updateStaticTimeline]),
          n.content.eventCallback("onUpdate", function(a, b, d, e, f, g, h, i) {
              "column" === e._nctype && z(c, k),
              punchgs.TweenLite.set(d, {
                  visibility: "visible"
              }),
              e.current_frame = g,
              ...
              e.visibleelement = !0
          }, [e, d._id, d._pw, d, f, g, jQuery.extend(!0, {}, y.anim), a.updateStaticTimeline]),
          n.content.eventCallback("onComplete", function(a, d, e, f, g, h, i) {
              var j = {};
              j.layer = c,
              j.eventtype = 0 === a ? "enteredstage" : a === d - 1 || a === e ? "leftstage" : "frameended",
              j.layertype = c.data("layertype"),
              j.layersettings = c.data(),
              k.c.trigger("revolution.layeraction", [j]),
              "leftstage" !== j.eventtype && b.animcompleted(c, k),
              "leftstage" === j.eventtype && b.stopVideo && b.stopVideo(c, k),
              ...
              "leftstage" === j.eventtype && (g.active = !1,
          ...
          }, [g, d.frames.length, s, d._pw, d, f, a.updateStaticTimeline]),
          f
      },
      ...
      playAnimationFrame: function(a) {
          ...
          var e, c = f(a), d = a.caption.data(), g = 0;
          for (var h in d.frames)
              d.frames[h].framename === a.frame && (e = g),
              g++;
  ...
  var f = function(a) {
    ...
    , h = function(a, b) {
      ...
      case "middletoedge":
          ...
          break;
      case "edgetomiddle":
          for (var f = a, h = 0, d = 0; d <= Math.floor(a / 2); d++)
              c.push(f),
              h < f && c.push(h),
              f--,
              h++
    ...
    , q = function(a, b, c, d, e) {
      ...
      return g && jQuery.each(g, function(a, b) {
          ...
          "rotationX" != i && "rX" != i || (f.anim.rotationX = o(j, f.anim.rotationX, d, e, "deg")),
          "rotationY" != i && "rY" != i || (f.anim.rotationY = o(j, f.anim.rotationY, d, e, "deg")),
          "rotationZ" != i && "rZ" != i || (f.anim.rotation = o(j, f.anim.rotationZ, d, e, "deg")),
          "scaleX" != i && "sX" != i || (f.anim.scaleX = o(j, f.anim.scaleX, d, e)),
          "scaleY" != i && "sY" != i || (f.anim.scaleY = o(j, f.anim.scaleY, d, e)),
          "opacity" != i && "o" != i || (f.anim.opacity = o(j, f.anim.opacity, d, e)),
          ...
          "skewX" != i && "skX" != i || (f.anim.skewX = o(j, f.anim.skewX, d, e)),
          "skewY" != i && "skY" != i || (f.anim.skewY = o(j, f.anim.skewY, d, e)),
          "x" == i && (f.anim.x = o(j, f.anim.x, d, e)),
          "y" == i && (f.anim.y = o(j, f.anim.y, d, e)),
          "z" == i && (f.anim.z = o(j, f.anim.z, d, e)),
