...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelectorAll(".service-row").forEach((row) => {
    ...
    row.addEventListener("contextmenu", function (event) {
      ...
      if (addFeatureBtn)
        addFeatureBtn.setAttribute("data-service-id", serviceId);
      if (editServiceBtn)
        editServiceBtn.setAttribute("data-service-id", serviceId);
      if (deleteServiceBtn)
        deleteServiceBtn.setAttribute("data-service-id", serviceId);
